...
Use this checklist before publishing `pretuiy`, creating a GitHub release, or
...
- [ ] Root and package versions are updated consistently.
...
- [ ] Demo smoke checks pass:
      `pnpm --filter pretuiy exec node dist/bin.js demo --snapshot --no-color`.
...
- [ ] Published package version matches the tag and release notes.
