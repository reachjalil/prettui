...
import { stripAnsi, visibleLength } from "pretuiy";
import { renderTuiDemo } from "../src/demo/renderDemo";
import { kitchenSinkComponentIndexById } from "../src/demo/kitchenSinkData";

describe("pretuiy demo", () => {
  ...
  it("renders the mock2 dashboard through pretuiy layout elements", () => {
