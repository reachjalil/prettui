...
preTUIy renders terminal UI frames and ships a CLI demo. Treat terminal escape
handling, package publishing, and executable behavior as security-sensitive.

## Supported Versions

Security reports are accepted for the current published `pretuiy` package.
...
https://github.com/reachjalil/pretuiy/security/advisories/new

For non-sensitive bugs, use GitHub issues:

https://github.com/reachjalil/pretuiy/issues
