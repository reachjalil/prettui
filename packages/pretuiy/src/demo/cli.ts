...
function demoHelp(): string {
  return [
    ...
    "",
    "Usage:",
    "  pretuiy demo [--choice <name>] [--snapshot] [--cols <n>] [--rows <n>] [--no-color]",
    "",
    "Choices:",
    `  ${demoChoices.join(", ")}`,
    "",
...
export function runPretuiyCli(argv = process.argv.slice(2), io: PretuiyCliIo = {}): number {
