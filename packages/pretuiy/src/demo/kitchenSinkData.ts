...
export const tuiKitchenSinkDefinitions = [
  {
    ...
    optionGroups: componentOptions("default", [
      { id: "default", label: "preTUIy", description: "Dot wordmark with live product status." },
      { id: "library", label: "preTUIy", description: "Package-oriented title and workspace state." },
